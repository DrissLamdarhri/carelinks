/**
 * CareLink — Realtime hooks (shared).
 * Uses only React hooks + Supabase JS — 100% compatible with React Native.
 * The only change from src/lib/db/realtime.ts is the supabase import path.
 */
